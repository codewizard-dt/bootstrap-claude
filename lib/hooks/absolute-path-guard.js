...
//
// Fails: open — this hook reads nothing but the command string, so no check can
// be left unrun; a throw exits 0 via lib/command-parse.js. Its firing rule is
// the conservative half: an evasive spelling blocks even when the underlying
// command would have been allowed.
// ---------------------------------------------------------------------------
