...
//
// Fails: closed — every uncertain outcome denies. A sibling guard that is
// missing, times out, crashes, or answers with something that is not a decision
// envelope blocks; a deny list that cannot be read blocks; a payload that cannot
// be isolated blocks. The one exception sits upstream of this file: a hook
// payload that is not parseable JSON exits 0 in lib/command-parse.js, which is
// fail-OPEN by design there.
