...
3. **If only a number is provided** (e.g., `3`):
   - Search `wiki/work/tasks/` for a file starting with that number
...
When adding specificity to vague steps, follow the `/research` workflow (see `lib/skills/research/SKILL.md`):
