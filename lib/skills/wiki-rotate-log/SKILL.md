...
Rotate `wiki/log.md` into a timestamped archive file (`log-YYYY_MM_DD_HHMMSS.md`) when it exceeds ~500 lines. Create a fresh `log.md` with an archive-pointer header. **Never truncate** — all content moves to the timestamped file.
