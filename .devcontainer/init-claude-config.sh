...
cd "/workspaces/basic-project-setup"
claude mcp add serena -- uvx --from git+https://github.com/oraios/serena serena start-mcp-server --context claude-code --project /workspaces/basic-project-setup 2>&1 || echo "Serena already registered, skipping"
