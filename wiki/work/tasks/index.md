...
- [TASK-077 — Docker harness: add PASS/FAIL status lines to setup/update/stale modes, and fix update mode's && short-circuit so update-project.sh actually runs](TASK-077-docker-harness-pass-fail-lines.md) — makes UAT-060's EDGE-011 and UAT-071's EDGE-004 automatable, matching idempotency mode's existing PASS/FAIL pattern · todo