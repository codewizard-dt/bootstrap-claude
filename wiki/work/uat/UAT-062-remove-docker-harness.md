...
- [ ] Repo checked out at `/Users/davidtaylor/Repositories/bootstrap-claude` with TASK-078's changes applied (harness files removed via `git rm`, pointer row removed from `lib/scripts/README.md`)
- [ ] Node.js available (`node --test` support)
