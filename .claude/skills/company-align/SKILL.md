...
- Check `.docs/tasks/`, `.docs/prd/`, `.docs/roadmaps/` for declared scope and in-progress work
...
- Are there obvious TODOs, stub implementations, or known gaps in `.docs/bugs/` or task backlogs?
