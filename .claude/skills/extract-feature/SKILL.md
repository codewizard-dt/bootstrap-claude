...
3. **Clarifying questions** — ask before proceeding if any are ambiguous:
   ...
   - **Supplementary output**: Should this skill also create a task file in `.docs/tasks/` to track the actual extraction work? (Default: yes, suggest it)
...
- Check `.docs/adr/` for accepted decisions that constrain how this feature may be restructured
