...
- If `$ARGUMENTS` is empty, fall back to requirements docs in `.docs/prd/` and `.docs/adr/`; if none exist, ask the user to specify the expected functionality before continuing.
