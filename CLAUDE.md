...
- `npx @codewizard-dt/bootstrap setup` — runs `lib/scripts/setup-project.sh` (installs hooks and skills globally, syncs wiki scaffold + `.docs/guides/` scaffold, bootstraps Serena; does NOT set up deployment)
